<template>
  <div class="overall">
    <Filter v-if="logged" @item-click="cpnClick"></Filter>
    <div class="display">
      <div class="top2">
      ...
      >
        <el-table-column
          ...
          align="center"
        ></el-table-column>
        <el-table-column prop="author_name" label="Name" width="200" align="center">
        ...
        >
          ...
          <template #default="{ row }">
            <el-link type="primary" @click="itemClick(row.problem_id)">{{
              row.problem_id
            }}</el-link>
          </template>
        </el-table-column>
...
<script>
import { ref } from "vue";
import Filter from "@/components/Status/Filter.vue";
...
export default {
  ...
  components: { Filter, ArrowDown, Search },
  methods: {
    ...
    getStatusList(myself, result, user_name,problem_id, page, pagesize) {
      getStatusList(myself, result, user_name,problem_id, page, pagesize)
        .then((res) => {
