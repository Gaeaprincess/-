<template>
  <div class="layout">
    <el-card style="width: 800px; display: flex; background-color: rgb(233, 240, 246);">{{time}} &nbsp;&nbsp;&nbsp;&nbsp;<span>订单编号：{{orderlist.ID}}</span>
      ...
      >
        <el-button><el-icon><chat-dot-round /></el-icon> &nbsp;&nbsp;计算机科学与工程学院算法竞赛部</el-button>
      </el-tooltip>
    </el-card>
    <el-table :show-header="status" :data="tableData" max-height="800" class="table" stripe>

      <el-table-column align="center" label="11" prop="CreatedAt" width="130px">
        <template #default="scope">
          <span style="margin-left: 10px" type="date"><img :src="'http://114.132.236.147:8001/onlinejudge' + scope.row.UpdatedAt" alt="" style="width: 100px; height: 100px;"></span>
        </template>
      </el-table-column>
